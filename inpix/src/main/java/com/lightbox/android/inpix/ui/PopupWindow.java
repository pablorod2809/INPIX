...
class PopupWindow extends GLView {
    ...
    private static final String TAG = "INPIX-PopUpWindow";
    ...
    private void renderBackgroundWithStencil(GLRootView root, GL11 gl) {
        ...
        Log.i(TAG, "renderBackgroundWithStencil" );
    ...
    public void popup() {
        ...
        Animation scale = new ScaleAnimation(
                0.2f, 1f, 0.2f, 1f, getWidth(), mAnchorPosition);
    ...
    public void popoff() {
        ...
        AnimationSet set = new AnimationSet(false);
        Animation scale = new ScaleAnimation(
                1f, 0.5f, 1f, 0.5f, getWidth(), mAnchorPosition);
        Animation alpha = new AlphaAnimation(0.7f, 0.0f);
