...
import static com.lightbox.android.inpix.Util.Assert;
...
public abstract class CameraHolder {
    ...
    public static synchronized CameraHolder instance() {
        if (sHolder == null) {
            if (Build.VERSION.SDK_INT >= 0x00000009 /*Build.VERSION_CODES.GINGERBREAD*/) {
                if (Build.MODEL.equals("PC36100") || Build.MODEL.equals("HTC Desire S")) { //TODO1 add HTC Sensation 4G
                ...
                } else if (Build.MODEL.equals("ZP100") || Build.BRAND.toUpperCase().equals("ZOPO")) {
                    sHolder = new ZOPOGingerbreadCameraHolder();
                } else if (Build.MODEL.equals("XT1032") || Build.BRAND.toUpperCase().equals("MOTOROLA")) {
                    sHolder = new MOTOGingerbreadCameraHolder();
                } else if (Build.BRAND.toUpperCase().equals("SAMSUNG-SM-G900H")) {
                    sHolder = new GingerbreadCameraHolder();
                } else if (Build.BRAND.toUpperCase().equals("SAMSUNG")) {
                    sHolder = new SAMSUNGGingerbreadCameraHolder();
                } else {
            		sHolder = new GingerbreadCameraHolder();
            	}
    ...
    public abstract int getAdditionalRotation(int cameraId, int orientationSensorValue);
