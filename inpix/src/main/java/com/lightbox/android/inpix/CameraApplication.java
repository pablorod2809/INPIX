...
import com.lightbox.android.inpix.util.MyLocation;
import com.lightbox.android.inpix.util.MyLocation.LocationResult;
...
public class CameraApplication extends Application {
	...
	private Typeface getNormalFont() {
		if(normalFont == null) {
			normalFont = Typeface.createFromAsset(getAssets(), "fonts/dosis-light.ttf");
		}
	...
	private Typeface getBoldFont() {
		if(boldFont == null) {
			boldFont = Typeface.createFromAsset(getAssets(),"fonts/dosis-medium.ttf");
		}
