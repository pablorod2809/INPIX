...
public class CameraSettings {
    ...
    private static final int MMS_VIDEO_DURATION =  60; //Cambio PR. (Build.VERSION.SDK_INT >= 0x00000008) ? CamcorderProfile.get(CamcorderProfile.QUALITY_LOW).duration : 60;
    ...
    private void buildExposureCompensation(
        ...
        int maxValue = (int) (float)Math.floor(max * step);
        int minValue = (int) (float)Math.ceil(min * step);
