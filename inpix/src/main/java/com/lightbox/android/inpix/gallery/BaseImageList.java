...
package com.lightbox.android.inpix.gallery;

import com.lightbox.android.inpix.ImageManager;
import com.lightbox.android.inpix.gallery.BaseImage;
import com.lightbox.android.inpix.gallery.IImage;
import com.lightbox.android.inpix.gallery.IImageList;
import com.lightbox.android.inpix.gallery.LruCache;
...
public abstract class BaseImageList implements IImageList {
    ...
    public BaseImageList(ContentResolver resolver, Uri uri, int sort,
        ...
        // TODO1: We need to clear the cache because we may "reopen" the image
    ...
    // TODO1: Change public to protected
    public Uri contentUri(long id) {
        // TODO1: avoid using exception for most cases
        try {
